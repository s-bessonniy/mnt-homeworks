# Домашнее задание к занятию "13.Системы мониторинга" - Сергей Яремко
...
- HTTP запросы, т.к это основной способ взаимодействия с платформой, необходимо отслеживать коллисчетсво запросов HTTP, распределение статусов ответов.
...
- Минусы:
  - агент - это дополнительная точка отказа. Есть вероятность выхода из строя агента, а сам сервис работает в штатном режиме
